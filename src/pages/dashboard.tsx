      ...
      >
        ...
        <div className='sidebar relative h-60 md:h-screen'>
          ...
          <div className='text relative m-16 max-w-xs'>
            <h3>TX Affiliate</h3>
            <ul><li><Icon1 /><span>Dashboard</span></li></ul>
            <h3>General</h3>
            <ul>
              <li><Icon1 /><span>Events</span></li>
              <li><Icon1 /><span>Reports</span></li>
              <li><Icon1 /><span>Settings</span></li>
            </ul>
          </div>
        </div>
          ...
          <div className="content-wrap">
            <div className='m-auto flex w-full flex-col gap-5'>
              <section className="flex flex-col items-center my-40">
                <h3 className='text-lg'>Affiliate Dashboard content goes here...</h3>
              </section>
            </div>
